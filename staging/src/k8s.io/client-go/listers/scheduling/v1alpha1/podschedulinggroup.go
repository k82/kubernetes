...
type PodSchedulingGroupLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.PodSchedulingGroup, err error)
...
// List lists all PodSchedulingGroups in the indexer.
func (s *podSchedulingGroupLister) List(selector labels.Selector) (ret []*v1alpha1.PodSchedulingGroup, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.PodSchedulingGroup))
	})
	return ret, err
}
...
type PodSchedulingGroupNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.PodSchedulingGroup, error)
...
// List lists all PodSchedulingGroups in the indexer for a given namespace.
func (s podSchedulingGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.PodSchedulingGroup, err error) {
...
// Get retrieves the PodSchedulingGroup from the indexer for a given namespace and name.
func (s podSchedulingGroupNamespaceLister) Get(name string) (*v1alpha1.PodSchedulingGroup, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("podschedulinggroup"), name)
	}
	return obj.(*v1alpha1.PodSchedulingGroup), nil
}
