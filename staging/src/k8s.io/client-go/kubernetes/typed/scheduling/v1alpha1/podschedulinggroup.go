...
type PodSchedulingGroupInterface interface {
	Create(*v1alpha1.PodSchedulingGroup) (*v1alpha1.PodSchedulingGroup, error)
	Update(*v1alpha1.PodSchedulingGroup) (*v1alpha1.PodSchedulingGroup, error)
	UpdateStatus(*v1alpha1.PodSchedulingGroup) (*v1alpha1.PodSchedulingGroup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.PodSchedulingGroup, error)
	List(opts v1.ListOptions) (*v1alpha1.PodSchedulingGroupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PodSchedulingGroup, err error)
...
func newPodSchedulingGroups(c *SchedulingV1alpha1Client, namespace string) *podSchedulingGroups {
...
func (c *podSchedulingGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.PodSchedulingGroup, err error) {
	result = &v1alpha1.PodSchedulingGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *podSchedulingGroups) List(opts v1.ListOptions) (result *v1alpha1.PodSchedulingGroupList, err error) {
	result = &v1alpha1.PodSchedulingGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("podschedulinggroups").
...
func (c *podSchedulingGroups) Create(podSchedulingGroup *v1alpha1.PodSchedulingGroup) (result *v1alpha1.PodSchedulingGroup, err error) {
	result = &v1alpha1.PodSchedulingGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("podschedulinggroups").
...
func (c *podSchedulingGroups) Update(podSchedulingGroup *v1alpha1.PodSchedulingGroup) (result *v1alpha1.PodSchedulingGroup, err error) {
	result = &v1alpha1.PodSchedulingGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podschedulinggroups").
...
func (c *podSchedulingGroups) UpdateStatus(podSchedulingGroup *v1alpha1.PodSchedulingGroup) (result *v1alpha1.PodSchedulingGroup, err error) {
	result = &v1alpha1.PodSchedulingGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podschedulinggroups").
...
func (c *podSchedulingGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PodSchedulingGroup, err error) {
	result = &v1alpha1.PodSchedulingGroup{}
