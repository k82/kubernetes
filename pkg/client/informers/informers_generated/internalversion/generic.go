...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case scheduling.SchemeGroupVersion.WithResource("podschedulinggroups"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Scheduling().InternalVersion().PodSchedulingGroups().Informer()}, nil
