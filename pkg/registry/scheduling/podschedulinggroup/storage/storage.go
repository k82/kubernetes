...
import (
	...
	"k8s.io/kubernetes/pkg/registry/scheduling/podschedulinggroup"
)
...
func NewREST(optsGetter generic.RESTOptionsGetter) *REST {
	store := &genericregistry.Store{
		...
		DefaultQualifiedResource: scheduling.Resource("podschedulinggroups"),

		CreateStrategy: podschedulinggroup.Strategy,
		UpdateStrategy: podschedulinggroup.Strategy,
		DeleteStrategy: podschedulinggroup.Strategy,
	}
